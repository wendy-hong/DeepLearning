...
rnn_forecast_seq2vec = model_forecast(model, series[split_time - window_size:-1], window_size)[:, 0]
mae_seq2vec = tf.keras.metrics.mean_absolute_error(x_valid, rnn_forecast_seq2vec).numpy()
print(mae_seq2vec)
...
rnn_forecast_seq2seq = model_forecast(model, series[..., np.newaxis], window_size)
rnn_forecast_seq2seq = rnn_forecast_seq2seq[split_time - window_size:-1, -1, 0]
mae_seq2seq = tf.keras.metrics.mean_absolute_error(x_valid, rnn_forecast_seq2seq).numpy()
print(mae_seq2seq)
